    ...
    class IndexAsTable < ActiveAdmin::Component
      ...
      class IndexTableFor < ::ActiveAdmin::Views::TableFor
        ...
        def selectable_column
          column( input( :type => "checkbox", :id => "collection_selection_toggle_all", :name => "collection_selection_toggle_all" ), { :class => "selectable" } ) { |resource| input :type => "checkbox", :id => "batch_action_item_%d" % resource.id, :value => resource.id, :class => "collection_selection", :name => "collection_selection[]" }
        end
